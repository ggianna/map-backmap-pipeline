...
class Plotter():
    ...
    def plot_assignment(self, encoder, elements_list):
        """Saves the assighment matrix, with colormap to indicate 
    ...
    def plot_loss(self, losses, legend):
        """Plots the loss over the training set and the test set during 
        training as well as the various loss components
        Arguments:
        ---------
